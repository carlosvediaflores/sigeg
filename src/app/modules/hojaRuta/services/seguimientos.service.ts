...
export class SeguimientosService {
  ...
  createArchivador(archivo: Partial<HrArchivado>) {
    console.log('createArchivador', archivo);
    return this.http.post<HrArchivado>(`${baseUrl}/seguimientos/create-archivado`, archivo)
  }
  ...
  archivarSeguimiento(
    ...
    console.log('Archivar seguimiento', {
      id,
      archivador,
      smsArchivado,
    });
    ...
    return this.http.patch(
      `${environment.baseUrl}/seguimientos/${id}/archivar`,
      {
        archivador,
        smsArchivado,
      }
